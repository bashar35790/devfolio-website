...
export default function StatsCounter() {
  ...
  return (
    <div className="border-y border-border-subtle bg-bg-page/20 backdrop-blur-sm relative z-10">
      <Container>
        <div ref={containerRef} className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8 py-12 md:py-16">
