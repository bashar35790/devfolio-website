          ...
          <div className="relative max-w-5xl mx-auto glass rounded-[2.5rem] p-8 md:p-16 border border-border-subtle overflow-hidden group shadow-2xl">
            ...
            <div className="relative z-10 grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="space-y-6 text-center lg:text-left">
                ...
                <h2 className="text-3xl md:text-5xl font-bold text-text-main tracking-tight leading-tight">
                  Stay Ahead of the <br className="hidden lg:block" />
                  <span className="text-gradient bg-gradient-to-r from-primary via-primary/80 to-text-main">Curve.</span>
                </h2>
                <p className="text-text-muted text-lg leading-relaxed max-w-md mx-auto lg:mx-0">
              ...
              <div className="w-full max-w-md mx-auto lg:mx-0 lg:ml-auto">
                <form className="relative" onSubmit={(e) => e.preventDefault()}>
                  ...
                  <div className="relative flex flex-col sm:flex-row gap-4 p-2 bg-bg-section rounded-2xl border border-border-subtle shadow-2xl">
                    <input
                      type="email"
                      placeholder="Enter your email address"
                      required
                      className="flex-1 px-6 py-4 bg-transparent text-text-main placeholder-text-muted/60 focus:outline-none w-full"
                    />
                    <Magnetic>
                      <button
                        type="submit"
